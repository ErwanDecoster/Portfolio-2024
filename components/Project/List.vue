...
<template>
  <div class="grid xl:grid-cols-2 gap-8 md:gap-14 items-center overflow-visible">
    <div class="relative border order-1 xl:order-none h-full p-9 rounded-2xl flex justify-end overflow-hidden">
    ...
    <div class="relative overflow-visible">
      <div class="grid">
        <NuxtLink 
          ...
          class="__appear-button flex items-center gap-1 group h-20 sm:hover:h-64 md:hover:h-80 relative group text-2xl uppercase py-6 hover:py-0 duration-150 hover:tracking-widest hover:z-10 hover:font-bold"
          :data-img="project.img"
        >
          <NuxtImg 
            id="__appear-img"
            class="h-full w-0 group-hover:w-full bottom-0 aspect-video group-hover:opacity-100 hidden sm:block duration-300 opacity-0 transition-opacity z-10 pointer-events-none object-cover bg-navy-blue"
            :src="project.img"
            placeholder
            format="webp"
            loading="lazy"
