...
<template>
  ...
  >
    <header
      id="__header"
      class="sticky top-0 pt-48 h-screen duration-75"
    >
    ...
    >
      ...
      <div class="grid gap-7">
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-7">
          ...
          <div class="h-[450px] sm:h-[480px] overflow-hidden group relative px-4 rounded-2xl border border-black dark:border-white duration-150 bg-navy-blue sm:bg-transparent sm:hover:bg-navy-blue text-pink">
            <p class="
              w-full pl-4 absolute top-8 sm:opacity-0 duration-150
            ...
            <p class="
              absolute sm:left-1/2 sm:top-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 text-2xl sm:text-center sm:text-black sm:dark:text-white duration-150 
            ...
            <p class="
              absolute top-44 inset-x-4 sm:opacity-0 duration-150
              sm:group-hover:opacity-100
            ">
              Developpement d'interface responsive, rapide, optimisé et instalable en PWA.
            </p>
            <div class="
              absolute top-72 inset-x-4 grid gap-2 grid-cols-4 text-xs sm:opacity-0 duration-150
              sm:group-hover:opacity-100
            ">
              <span class="__pointer rounded-full py-1 duration-150 text-center border border-pink hover:bg-pink hover:text-navy-blue">Javascript</span>
              <span class="__pointer rounded-full py-1 duration-150 text-center border border-pink hover:bg-pink hover:text-navy-blue">TypeScrypt</span>
              <span class="__pointer rounded-full py-1 duration-150 text-center border border-pink hover:bg-pink hover:text-navy-blue">Nuxt</span>
              <span class="__pointer rounded-full py-1 duration-150 text-center border border-pink hover:bg-pink hover:text-navy-blue">VueJs</span>
              <span class="__pointer rounded-full py-1 duration-150 text-center border border-pink hover:bg-pink hover:text-navy-blue">PostgreSQL</span>
              <span class="__pointer rounded-full py-1 duration-150 text-center border border-pink hover:bg-pink hover:text-navy-blue">Supabase</span>
              <span class="__pointer rounded-full py-1 duration-150 text-center border border-pink hover:bg-pink hover:text-navy-blue">TailwindCSS</span>
              <span class="__pointer rounded-full py-1 duration-150 text-center border border-pink hover:bg-pink hover:text-navy-blue">HTML</span>
              <span class="__pointer rounded-full py-1 duration-150 text-center border border-pink hover:bg-pink hover:text-navy-blue">CSS</span>
              <span class="__pointer rounded-full py-1 duration-150 text-center border border-pink hover:bg-pink hover:text-navy-blue">SASS</span>
              <span class="__pointer rounded-full py-1 duration-150 text-center border border-pink hover:bg-pink hover:text-navy-blue">PHP</span>
              <span class="__pointer rounded-full py-1 duration-150 text-center border border-pink hover:bg-pink hover:text-navy-blue">SQL</span>
            </div>
          </div>
          <div class="h-[450px] sm:h-[480px] overflow-hidden group relative px-4 rounded-2xl border border-black dark:border-white duration-150 bg-pink sm:bg-transparent sm:hover:bg-pink text-navy-blue">
            <p class="
              w-full pl-4 absolute top-8 sm:opacity-0 duration-150
            ...
            <div class="
              absolute top-72 left-1/2 -translate-x-1/2 place-items-center grid grid-cols-6 text-xs sm:opacity-0 w-max duration-150
              sm:group-hover:opacity-100
            ">
              <span class="block size-7 m-1 rounded-full duration-150 bg-white hover:bg-navy-blue" />
              <span class="block size-7 m-1 rounded-full duration-150 bg-white hover:bg-navy-blue" />
              <span class="block size-7 m-1 rounded-full duration-150 bg-white hover:bg-navy-blue" />
              <span class="block size-7 m-1 rounded-full duration-150 bg-white hover:bg-navy-blue" />
              <span class="block size-7 m-1 rounded-full duration-150 bg-navy-blue hover:bg-white" />
              <span class="block size-7 m-1 rounded-full duration-150 bg-white hover:bg-navy-blue" />
              <span class="block size-7 m-1 rounded-full duration-150 bg-white hover:bg-navy-blue" />
              <span class="block size-7 m-1 rounded-full duration-150 bg-white hover:bg-navy-blue" />
              <span class="block size-7 m-1 rounded-full duration-150 bg-white hover:bg-navy-blue" />
          ...
          <div class="h-[450px] sm:h-[480px] overflow-hidden group relative px-4 rounded-2xl border border-black dark:border-white duration-150 bg-black sm:bg-transparent sm:hover:bg-black text-white">
            <p class="
              w-full pl-4 absolute top-8 sm:opacity-0 duration-150
            ...
            <div class="
              absolute top-72 text-xs inset-x-4 sm:opacity-0 duration-150
              sm:group-hover:opacity-100
            ">
